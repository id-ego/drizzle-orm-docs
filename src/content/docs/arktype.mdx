...
`drizzle-arktype`는 **[Drizzle ORM](https://github.com/drizzle-team/drizzle-orm)**의 플러그인으로, Drizzle ORM 스키마로부터 **[Arktype](https://arktype.io/)** 스키마를 생성할 수 있습니다.
...
이 문서는 `drizzle-arktype@0.1.0` 이상 버전을 위한 문서입니다.

Drizzle ORM v0.36.0 이상, Arktype v2.0.0 이상이 설치되어 있어야 합니다.
</Callout>
...
각 create 스키마 함수는 추가 선택적 매개변수를 받아 필드의 스키마를 확장, 수정 또는 완전히 덮어쓸 수 있습니다. 콜백 함수를 정의하면 확장하거나 수정하고, arktype 스키마를 제공하면 덮어씁니다.
